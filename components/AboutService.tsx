      ...
      <div className="max-w-5xl mx-auto relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_3fr] gap-10 lg:gap-16 items-start">
          ...
          <div className="flex flex-col gap-5 text-am-muted text-[15px] leading-relaxed">
            ...
            <p>
              Trabajamos con pymes y emprendedores en todo Chile, desde Santiago y Concepción hasta Temuco, Puerto Montt y Punta Arenas. Nuestro servicio de posicionamiento en Google parte desde <strong className="text-white font-semibold">$199.990 pago único</strong>, sin mensualidades ni costos ocultos.
            </p>
          </div>
