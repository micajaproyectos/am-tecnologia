const serviceLinks = [
  ...
  { href: "/servicios/campanas-google-ads",      label: "Campaña de Google Ads + Landing" },
...
<SocialLink href="https://wa.me/56985660954" aria="WhatsApp" target="_blank" dataCtaSource="footer" noModal>
              ...
              <SocialLink href="https://g.page/r/CX_Uc-66lRnzEAE/review" aria="Reseña en Google" target="_blank">
...
function SocialLink({
  ...
  return (
    <a
      ...
      data-no-modal={noModal ? "" : undefined}
      aria-label={aria}
      target={target}
