...
const securityHeaders = [
  ...
  // CSP: permite Google Ads, GA4 y Clarity; bloquea plugins y base-tag injection
  {
    ...
    value: [
      ...
      "font-src 'self'",
      "connect-src 'self' https://www.google-analytics.com https://analytics.google.com https://stats.g.doubleclick.net https://script.google.com https://region1.google-analytics.com https://www.google.com https://www.googleadservices.com https://googleads.g.doubleclick.net",
